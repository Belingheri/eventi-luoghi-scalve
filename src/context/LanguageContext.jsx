...
const UI_TRANSLATIONS = {
  ...
  // Hero
  hero_badge: { it: 'Val di Scalve — Guida ed Eventi (Non Ufficiale)', en: 'Val di Scalve — Guide & Events (Unofficial)', de: 'Val di Scalve — Führer & Events (Inoffiziell)', fr: 'Val di Scalve — Guide & Événements (Non Officiel)', es: 'Val di Scalve — Guía y Eventos (No Oficial)' },
  ...
  footer_tagline: { it: 'Guida indipendente non ufficiale della Val di Scalve: Schilpario, Vilminore, Colere, Azzone.', en: 'Unofficial independent guide to Scalve Valley: Schilpario, Vilminore, Colere, Azzone.', de: 'Inoffizieller unabhängiger Führer des Scalvetals: Schilpario, Vilminore, Colere, Azzone.', fr: 'Guide indépendant non officiel de la Val di Scalve: Schilpario, Vilminore, Colere, Azzone.', es: 'Guía independiente no oficial del Valle di Scalve: Schilpario, Vilminore, Colere, Azzone.' },
  ...
  privacy_item1_title: { it: 'ℹ️ Finalità del Progetto (Non Ufficiale):', en: 'ℹ️ Project Purpose (Unofficial):', de: 'ℹ️ Zweck des Projekts (Inoffiziell):', fr: 'ℹ️ Objectif du Projet (Non Officiel):', es: 'ℹ️ Propósito del Proyecto (No Oficial):' },
  privacy_item1_desc: { it: 'Questo sito è un progetto guida indipendente non ufficiale. Per il portale turistico istituzionale ufficiale fai riferimento a valdiscalve.it.', en: 'This website is an unofficial independent guide project. For the official institutional tourism portal please refer to valdiscalve.it.', de: 'Diese Website ist ein inoffizielles unabhängiges Projekt. Das offizielle Portal finden Sie unter valdiscalve.it.', fr: 'Ce site est un projet de guide indépendant non officiel. Pour le portail officiel référez-vous à valdiscalve.it.', es: 'Este sitio es un proyecto de guía independiente no oficial. Para el portal oficial visita valdiscalve.it.' },
